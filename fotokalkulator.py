...
def main(argv):
    print("Ulazna datoteka: " + sys.argv[1])
    # s = pytesseract.image_to_string(Image.open('op.png'))
    s = pytesseract.image_to_string(Image.open(sys.argv[1]))
    # s = unicode(s, errors='ignore')
	
    print("Prepoznati izraz: " + s)
    s = s.replace("o","0")
    s = s.replace("O","0")
    # s = s.replace("—","-")
    print("Obradjeni izraz: " + s)
    print("Rezultat: " + str(evaluate(s)))
